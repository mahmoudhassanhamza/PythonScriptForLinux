...
enum cache_policy
{
  ...
  NRU     /* Replace the one that is not recently used */
};
...
struct cache_blk_t
{
  ...
  byte_t used_bit;     /* used bit to impelement NRU */
...
struct cache_set_t
{
  ...
  unsigned int num_of_used;     /* indicates the number of used=1 for resetting */
...
struct cache_t
{
  ...
  unsigned int replacement_index; /* cache hit latency */
  ...
  unsigned int nru_pointer; /* used to search for a not recently used block */
